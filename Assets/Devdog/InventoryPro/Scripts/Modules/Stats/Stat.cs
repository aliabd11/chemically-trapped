...
namespace Devdog.InventoryPro
{
    ...
    public partial class Stat : IStat
    {
        ...
        private float _currentMaxValueRaw;
        public float currentMaxValue
        {
            get
            {
                return _currentMaxValueRaw * currentFactorMax;
            }
        }
        ...
        {
            SetMaxValueRaw(_currentMaxValueRaw + value, andIncreaseCurrentValue, fireEvents);
        }
