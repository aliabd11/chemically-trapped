    ...
    public partial class ConsumableUFPSInventoryItem : UFPSInventoryItemBase
    {
        ...
        public override GameObject Drop()
        {
            ...
            if (vp_MPPickupManager.Instance != null)
            {
                ...
                vp_MPPickupManager.Instance.photonView.RPC("InventoryDroppedObject", PhotonTargets.AllBuffered, (int)ID, itemPickup.ID, (int)currentStackSize, dropPos, Quaternion.identity);
