...
//            currentClipCount = 0;
        ...
        public override GameObject Drop()
        {
            ...
            if(InventoryMPUFPSPickupManager.instance != null)
                InventoryMPUFPSPickupManager.instance.photonView.RPC("InventoryDroppedObject", PhotonTargets.AllBuffered, (int)ID, itemPickup.ID, (int)currentClipCount, dropPos, Quaternion.identity);
