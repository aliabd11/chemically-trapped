                ...
                if (currentEquippable == null)
                {
                    if (GUILayout.Button("Position now"))
                    {
                        ...
                        if (currentInventoryPlayer != null)
                        {
                            ...
                            currentInventoryPlayer.characterUI.character = currentInventoryPlayer;
                            currentInventoryPlayer.characterUI.IndexManuallyDefinedCollection();
                            currentInventoryPlayer.characterUI.UpdateEquippableSlots();

                            currentBinder = currentInventoryPlayer.equipmentHandler.FindEquipmentLocation(currentInventoryPlayer.equipmentHandler.FindEquippableSlotForItem(t));
