...
namespace Completed
{
	...
	public class BossOneEnemy : MovingObject, IAttackable
	{
		public int playerDamage; 							//The amount of food points to subtract from the player when attacking.
		public AudioClip attackSound1;						//First of two audio clips to play when attacking the player.
		public AudioClip attackSound2;						//Second of two audio clips to play when attacking the player.
		public Sprite dmgSprite;					//Alternate sprite to display after Enemy has been attacked by player.
		public int hp = 3;							//hit points for the Enemy.
		...
		//DamageWall is called when the player attacks a enemy.
